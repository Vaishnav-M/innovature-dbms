...
Multi-tenant configuration with separate databases per company.
"""
...
# Default database for authentication and company metadata
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.sqlite3',
        'NAME': BASE_DIR / os.getenv('DEFAULT_DB_NAME', 'default_db.sqlite3'),
    }
}
